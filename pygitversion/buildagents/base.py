...
_log = logging.getLogger("pygitversion.buildagents")
...
def resolve(
    ...
    """
    from pygitversion.buildagents.github_actions import GitHubActions  # noqa: PLC0415
    from pygitversion.buildagents.gitlab_ci import GitLabCi  # noqa: PLC0415
