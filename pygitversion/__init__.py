...
Example::
    ...
    version = pygitversion.calculate(".")
    pygitversion.export_env(version, os.environ)
...
def calculate(
    ...
    *,
    ...
    from pygitversion.calculation.api import calculate_variables  # noqa: PLC0415
...
def export_env(
    ...
    *,
    ...
    """
    from pygitversion.buildagents.envexport import EnvExporter  # noqa: PLC0415
