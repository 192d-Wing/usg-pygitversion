...
from pygitversion.config import workflows
from pygitversion.config.locator import find_configuration_file
from pygitversion.config.merge import clone, merge
...
_log = logging.getLogger("pygitversion.config")
