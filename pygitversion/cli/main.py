...
(see :mod:`pygitversion.cli.arguments`). Exit codes follow upstream: 0 on
...
from pygitversion import __version__, app
from pygitversion.cli.arguments import parse_arguments
from pygitversion.cli.help import help_text
from pygitversion.errors import GitVersionError, UsageError
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        logging.getLogger("pygitversion").error("An unexpected error occurred", exc_info=True)
        sys.stderr.write(
